    ...
    <>
      <Sheet>
        <SheetTrigger asChild>
          <div 
            className="relative overflow-hidden rounded-xl p-6 backdrop-blur-lg border border-white/20 shadow-xl animate-fade-in noise transition-all duration-500 ease-out cursor-pointer
